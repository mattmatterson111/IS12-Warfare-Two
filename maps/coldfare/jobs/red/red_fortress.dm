...
/decl/hierarchy/outfit/job/medical/doctor/red
	...
	backpack_contents = list(/obj/item/gun/projectile/revolver/manual = 1, /obj/item/ammo_magazine/handful/revolver = 1, /obj/item/reagent_containers/food/drinks/canteen = 1)
