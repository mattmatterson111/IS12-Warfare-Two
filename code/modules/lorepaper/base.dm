...
/obj/structure/noticeboard/red
	notices = 2
	icon_state = "nboard02"

/obj/structure/noticeboard/red/New()
	var/obj/item/paper/P = new()
	P.SetName("Shardridge")
	P.info = "<br>What comes next will not be pretty, but it is something that has to be done to gain the upper hand in this conflict.<br><br>Their lines, inbound to the depot; will be of considerable use to us in the coming month. Prepare yourself for the assault."
	src.contents += P

	P = new()
	P.SetName("Memo")
	P.info = "<br>Infiltration tactics are prohibited as per executive order 487-W-D.<br>Wear an enemy uniform, <b>and you will be treated as such.</b>"
	src.contents += P