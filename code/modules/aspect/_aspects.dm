...
GLOBAL_LIST_INIT(possible_aspects, list(/datum/aspect/clean_guns, /datum/aspect/extramoney, /datum/aspect/additional_troops, /datum/aspect/one_word, /datum/aspect/no_guns, /datum/aspect/little_landmines))
