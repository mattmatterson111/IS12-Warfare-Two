...
/obj/machinery/kaos/cargo_machine/red
	...
	products = list(
		...
		list("name" = "HMG Ammo Pack", "price" = 100, "category" = "Ammunition", "path" = /obj/structure/closet/crate/scuffedcargo, "willcontain" = list(/obj/item/ammo_magazine/box/a556/lmg = 5)),
