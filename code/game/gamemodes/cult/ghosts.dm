...
/datum/antagonist/cultist/proc/add_ghost_magic(var/mob/observer/ghost/M)
	if(max_cult_rating >= CULT_GHOSTS_1)
		M.add_verbs(/mob/observer/ghost/proc/flick_lights)
		M.add_verbs(/mob/observer/ghost/proc/bloody_doodle)
		M.add_verbs(/mob/observer/ghost/proc/shatter_glass)
		M.add_verbs(/mob/observer/ghost/proc/slice)
		if(max_cult_rating >= CULT_GHOSTS_2)
			M.add_verbs(/mob/observer/ghost/proc/move_item)
			M.add_verbs(/mob/observer/ghost/proc/whisper_to_cultist)
			M.add_verbs(/mob/observer/ghost/proc/bite_someone)
			M.add_verbs(/mob/observer/ghost/proc/chill_someone)
			if(max_cult_rating >= CULT_GHOSTS_3)
				M.add_verbs(/mob/observer/ghost/proc/whisper_to_anyone)
				M.add_verbs(/mob/observer/ghost/proc/bloodless_doodle)
				M.add_verbs(/mob/observer/ghost/proc/toggle_visiblity)
