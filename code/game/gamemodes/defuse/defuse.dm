...
/datum/game_mode/warfare
	name = "Defuse"
	round_description = "We're under attack by terrorists!"
	extended_round_description = "Prevent them from destabilizing our great country!"
	config_tag = "warfare"
	required_players = 0
...
/proc/iswarfare()
    return (istype(ticker.mode, /datum/game_mode/warfare))
